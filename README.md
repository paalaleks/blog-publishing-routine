...
```bash
git clone https://github.com/paalaleks/blog-publishing-routine.git blog-publishing-routine
cd blog-publishing-routine
npm install
npm link
```

This registers the `blog-publishing-routine` command globally.
...
```bash
blog-publishing-routine --blog <key> --publish drafts/my-post.md
```

### Publish a new post with a hero image

```bash
blog-publishing-routine --blog <key> --publish drafts/my-post.md --image drafts/hero.png
```
...
```bash
blog-publishing-routine --blog <key> --add-image <slug> --image drafts/hero.png
```
...
2. Run `blog-publishing-routine --blog <key> --update <slug>`
